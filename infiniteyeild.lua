...
local Window = WindUI:CreateWindow({
	Name = "Infinite Yield FE v" .. currentVersion,
...
-- Notification system
notify = function(title, text, time)
	Window:Notify(title, text, time or 3)
end

-- Main Tab
local MainTab = Window:CreateTab("Main")
MainTab:CreateSection("Command")
local Cmdbar = MainTab:CreateTextBox("Command", "Command Bar (" .. prefix .. ")", "", function(text, enterPressed)
	if enterPressed then
		local cmd = text:gsub("^" .. prefix, "")
		execCmd(cmd, Players.LocalPlayer, true)
		Cmdbar:SetText("")
	end
end)

-- Command list (reuse original)
local CMDsF = Instance.new("ScrollingFrame")
CMDsF.BackgroundTransparency = 1
CMDsF.BorderSizePixel = 0
CMDsF.ScrollBarThickness = 8
CMDsF.VerticalScrollBarInset = Enum.ScrollBarInset.Always
CMDsF.Size = UDim2.new(1, -10, 1, -10)
CMDsF.Parent = MainTab:CreateSection("Commands"):GetFrame()
...
SettingsTab:CreateTextBox("Prefix", "Prefix", prefix, function(val)
	prefix = val
	Cmdbar:SetPlaceholder("Command Bar (" .. prefix .. ")")
	updatesaves()
end)
SettingsTab:CreateToggle("Keep Menu Open", StayOpen, function(val)
	StayOpen = val
	updatesaves()
end)
SettingsTab:CreateButton("Edit Theme", function()
...
Holder_2.ScrollBarThickness = 8
Holder_2.VerticalScrollBarInset = Enum.ScrollBarInset.Always
Holder_2.Size = UDim2.new(1, 0, 1, -40)
Holder_2.Parent = KeybindsTab:CreateSection("Binds"):GetFrame()
...
KeybindsTab:CreateButton("Add Keybind", function()
	KeybindEditor:TweenPosition(UDim2.new(0.5, -180, 0, 260), "InOut", "Quart", 0.5, true, nil)
end)
KeybindsTab:CreateButton("Clear Keybinds", function()
	binds = {}
	refreshbinds()
	updatesaves()
end)
...
-- Waypoints Tab
local WaypointsTab = Window:CreateTab("Waypoints")
Holder_4 = Instance.new("ScrollingFrame")
Holder_4.BackgroundTransparency = 1
Holder_4.BorderSizePixel = 0
Holder_4.ScrollBarThickness = 8
Holder_4.VerticalScrollBarInset = Enum.ScrollBarInset.Always
Holder_4.Size = UDim2.new(1, 0, 1, -40)
Holder_4.Parent = WaypointsTab:CreateSection("Waypoints"):GetFrame()
...
WaypointsTab:CreateButton("Set Waypoint", function() execCmd("swp " .. tostring(os.time())) end)
WaypointsTab:CreateButton("Clear Waypoints", function() execCmd("cwp") end)
WaypointsTab:CreateButton("Part Waypoint", function() selectPart() end)

-- Aliases Tab
local AliasesTab = Window:CreateTab("Aliases")
Holder_3 = Instance.new("ScrollingFrame")
Holder_3.BackgroundTransparency = 1
Holder_3.BorderSizePixel = 0
Holder_3.ScrollBarThickness = 8
Holder_3.VerticalScrollBarInset = Enum.ScrollBarInset.Always
Holder_3.Size = UDim2.new(1, 0, 1, -40)
Holder_3.Parent = AliasesTab:CreateSection("Aliases"):GetFrame()
...
AliasesTab:CreateButton("Clear Aliases", function() execCmd("clraliases") end)

-- Plugins Tab
local PluginsTab = Window:CreateTab("Plugins")
Holder_5 = Instance.new("ScrollingFrame")
Holder_5.BackgroundTransparency = 1
Holder_5.BorderSizePixel = 0
Holder_5.ScrollBarThickness = 8
Holder_5.VerticalScrollBarInset = Enum.ScrollBarInset.Always
Holder_5.Size = UDim2.new(1, 0, 1, -40)
Holder_5.Parent = PluginsTab:CreateSection("Plugins"):GetFrame()
...
PluginsTab:CreateButton("Add Plugin", function()
	PluginEditor:TweenPosition(UDim2.new(0.5, -180, 0, 310), "InOut", "Quart", 0.5, true, nil)
end)

-- Logs Tab
local LogsTab = Window:CreateTab("Logs")
LogsTab:CreateToggle("Chat Logs", logsEnabled, function(val)
	logsEnabled = val
	Toggle.Text = val and "Enabled" or "Disabled"
	updatesaves()
end)
LogsTab:CreateToggle("Join Logs", jLogsEnabled, function(val)
	jLogsEnabled = val
	Toggle_2.Text = val and "Enabled" or "Disabled"
	updatesaves()
end)
LogsTab:CreateButton("Clear Chat Logs", function()
	scroll_2:ClearAllChildren()
	scroll_2.CanvasSize = UDim2.new(0,0,0,10)
end)
LogsTab:CreateButton("Clear Join Logs", function()
	scroll_3:ClearAllChildren()
	scroll_3.CanvasSize = UDim2.new(0,0,0,10)
end)

local scroll_2 = Instance.new("ScrollingFrame")
scroll_2.BackgroundColor3 = Color3.fromRGB(0.18,0.18,0.18)
scroll_2.BorderSizePixel = 0
scroll_2.Size = UDim2.new(1,0,1,-5)
scroll_2.ScrollBarThickness = 8
scroll_2.CanvasSize = UDim2.new(0,0,0,10)
scroll_2.Parent = LogsTab:CreateSection("Chat Logs Display"):GetFrame()

local scroll_3 = Instance.new("ScrollingFrame")
scroll_3.BackgroundColor3 = Color3.fromRGB(0.18,0.18,0.18)
scroll_3.BorderSizePixel = 0
scroll_3.Size = UDim2.new(1,0,1,-5)
scroll_3.ScrollBarThickness = 8
scroll_3.CanvasSize = UDim2.new(0,0,0,10)
scroll_3.Parent = LogsTab:CreateSection("Join Logs Display"):GetFrame()

-- Event Binds Tab
local EventsTab = Window:CreateTab("Event Binds")
eventEditor.Frame.Parent = EventsTab:GetFrame()
eventEditor.Frame.Size = UDim2.new(1,0,1,0)
...
KeybindEditor.Size = UDim2.new(0, 360, 0, 200)
KeybindEditor.ZIndex = 10
KeybindEditor.Parent = PARENT  -- make sure PARENT exists

-- Plugin editor (popup)
PluginEditor = Instance.new("Frame")
PluginEditor.BackgroundTransparency = 1
PluginEditor.Position = UDim2.new(0.5, -180, 0, -500)
PluginEditor.Size = UDim2.new(0, 360, 0, 200)
...
ToPartFrame.Size = UDim2.new(0, 360, 0, 150)
ToPartFrame.ZIndex = 10
ToPartFrame.Parent = PARENT

-- Notification frame (popup) - kept for backward compatibility
...
-- Logs frame (old) - no longer used as main, but kept for reference
...
-- Color picker reference (will be created later by ColorsButton)
picker = Instance.new("Frame")
picker.BackgroundTransparency = 1
picker.Position = UDim2.new(0.5, -219, 0, -500)
picker.Size = UDim2.new(0, 438, 0, 350)
picker.ZIndex = 10
picker.Parent = PARENT

-- Drag functions for popups (reuse original dragGUI)
